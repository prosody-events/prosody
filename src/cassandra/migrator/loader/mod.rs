...
use crate::cassandra::{
    ...
    TABLE_KEYED_STATE_IDENTITY, TABLE_KEYED_STATE_VALUE, TABLE_KEYS, TABLE_SCHEMA_MIGRATIONS,
    TABLE_SEGMENTS, TABLE_SLABS, TABLE_TYPED_KEYS, TABLE_TYPED_SLABS,
};
...
pub fn load_embedded_migrations(keyspace: &str) -> Result<Vec<Migration>, super::MigrationError> {
    ...
    for filename in MigrationAssets::iter() {
        ...
        content_str = content_str
            ...
            .replace("{{TABLE_KEYED_STATE_VALUE}}", TABLE_KEYED_STATE_VALUE)
